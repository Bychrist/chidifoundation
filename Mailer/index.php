...
try {
  ...
  //  echo json_encode($data);
    ...
    $mail->addAddress($owneremail, " Chidi Anyaegbu Foundation");


    //Content
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = $subject;
    $mail->Body    = customerEmail($message,$phone,$name,$email);
    $mail->send();
